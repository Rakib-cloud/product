...
console.log(rate.dbbl3)
 ...
 <ul>
  ...
  <div> 
  <button onClick={() => details("${product._id}")} class=" btn  bg-slate-400">Add</button>
</div>
</ul>
 `;
  ...
  <div class="card bg-base-100 shadow-2xl w-1/2  items-center ml-20" >
        ...
        <div class="card-body items-center text-center">
          ...
          {
            clicked ? <>
              <label for="my-modal" class=" btn bg-success">Compare</label>
      ...
      <div class="px-10 pt-10">
            ...
            <p className='mt-3'>Price:<span id='product-price'>${info.price}</span>BDT</p>
      </div>
                </div>
  ...
  return (
    <div className=''>
      <div className='flex justify-end mr-5'>
        <button class="btn  bg-slate-400" onClick={handleClick} >ADD to Compare</button>
      ...
      <div class="card bg-base-100 shadow-2xl w-1/2  items-center ml-20" >
        ...
        <div class="card-body items-center text-center">
          ...
          <div className='flex'>
            {
              clicked ? <>
                <label for="my-modal" class="btn  bg-slate-400">Compare</label>
         ...
         <button class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold rounded-full" type="button" id="calculate-button"  onClick={handleClick2}>
          Calculate
                   ...
                   <h6 class="ms-5 ps-5"> Total months: <span id="total-month">0</span></h6>
                    ...
                    <div class="modal-action">
                      <label for="my-modal" class="btn  bg-slate-400">Buy!</label>
                    </div>
                  </div>
                </div>
              </> : <h2>noclick</h2>
            ...
            <div className='ml-5'>
              <button class="btn  bg-slate-400">Buy</button>
